...
def main():
    ...
    with open(problem_name + ".pddl", 'w') as f:
        ...
        f.write("(defproblem problem " + problem_name + "\n")
        f.write("\t(\n")
        ...
        for x in drone:
            ...
            brazo1 = brazos[i]
            f.write("\t(brazos-dron "+ x +" "+ brazos[i] +")\n")
            f.write("\t(libre-brazo "+ x +" "+ brazos[i] +")\n")
            i+=1
            f.write("\t(brazos-dron "+ x +" "+ brazos[i] +")\n")
            f.write("\t(libre-brazo "+ x +" "+ brazos[i] +")\n")
            f.write("\t(distintos "+ brazo1 +" "+ brazos[i] +")\n")
            i+=1
        ...
        for x in location:
            if x != "base":
                f.write("\t(cajas-localizacion " + content_types[0] + " " + x + " 0)\n")
                f.write("\t(cajas-localizacion " + content_types[1] + " " + x + " 0)\n")
        ...
        f.write("\t(cajas-base medicina "+ str(cajasMedBase) +")\n")
        f.write("\t(cajas-base comida "+ str(cajasComBase) +")\n")
