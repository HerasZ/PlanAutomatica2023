...
(:init
	...
	(= (coste-vuelo base loc1) 160)
	(= (coste-vuelo base loc2) 81)
	(= (coste-vuelo base loc3) 189)
	(= (coste-vuelo base loc4) 81)
	(= (coste-vuelo base loc5) 233)
	(= (coste-vuelo loc1 base) 160)
	(= (coste-vuelo loc1 loc1) 1)
	(= (coste-vuelo loc1 loc2) 90)
	(= (coste-vuelo loc1 loc3) 58)
	(= (coste-vuelo loc1 loc4) 146)
	(= (coste-vuelo loc1 loc5) 150)
	(= (coste-vuelo loc2 base) 81)
	(= (coste-vuelo loc2 loc1) 90)
	(= (coste-vuelo loc2 loc2) 1)
	(= (coste-vuelo loc2 loc3) 109)
	(= (coste-vuelo loc2 loc4) 62)
	(= (coste-vuelo loc2 loc5) 160)
	(= (coste-vuelo loc3 base) 189)
	(= (coste-vuelo loc3 loc1) 58)
	(= (coste-vuelo loc3 loc2) 109)
	(= (coste-vuelo loc3 loc3) 1)
	(= (coste-vuelo loc3 loc4) 149)
	(= (coste-vuelo loc3 loc5) 94)
	(= (coste-vuelo loc4 base) 81)
	(= (coste-vuelo loc4 loc1) 146)
	(= (coste-vuelo loc4 loc2) 62)
	(= (coste-vuelo loc4 loc3) 149)
	(= (coste-vuelo loc4 loc4) 1)
	(= (coste-vuelo loc4 loc5) 165)
	(= (coste-vuelo loc5 base) 233)
	(= (coste-vuelo loc5 loc1) 150)
	(= (coste-vuelo loc5 loc2) 160)
	(= (coste-vuelo loc5 loc3) 94)
	(= (coste-vuelo loc5 loc4) 165)
